...
const Hero = () => {
    ...
    return (
        <div>
            ...
            <div className='text-[#1A0B5B] text-[42px] font-semibold flex justify-center mb-5 ml-10'>Featured Products</div>
            <div className='grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 ml-10'>
            ...
            <div className='text-[#1A0B5B] text-[42px] font-semibold flex justify-center mb-5 ml-10'>Trending Products</div>
            <div className='grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 ml-10'>
                <div className='w-[270px] h-[361px] bg-slate-200 hover:scale-105'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="relative bg-[#FFF6FB] p-4 flex flex-col justify-between h-[250px]">
          <div
            ...
            style={{ backgroundImage: "url('/red1.png')"
        ...
        <div className="relative bg-[#EEEFFB] p-4 flex flex-col justify-between h-[250px]">
          <div
            className="absolute inset-0 bg-no-repeat bg-bottom h-full"
    ...
    <div className="text-center">
      ...
      <div className="flex justify-center space-x-4 text-gray-600 text-sm mt-2">
        ...
        <div><Image src={'/r3.png'} width={1300} height={1300} alt='truck'/>
        </div>
